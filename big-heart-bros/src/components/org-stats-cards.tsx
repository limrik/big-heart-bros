...
function getEventsWithOrg2Poster(userEvents: any[]): any[] {
  // Check if userEvents is null or undefined
  ...
  return (
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-gray-100 my-3 rounded px-4 py-6 border border-gray-200">
          ...
          <div className="bg-gray-100 my-3 w-[500] rounded px-4 py-6 border border-gray-200">
